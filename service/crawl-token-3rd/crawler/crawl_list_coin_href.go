...
import (
	"crawl-token-3rd-service/service/crawl-token-3rd/model/dto"
	"fmt"
	"time"
...
func CrawlListCoinHref(dom *goquery.Document) []*dto.CoinstatHref {

	listCoinstat := make([]*dto.CoinstatHref, 0)
